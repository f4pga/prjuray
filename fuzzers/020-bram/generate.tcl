...
set_property IS_ENABLED 0 [get_drc_checks {PDRC-163}]
set_property IS_ENABLED 0 [get_drc_checks {PDRC-165}]
set_property IS_ENABLED 0 [get_drc_checks {AVAL-150}]
set_property IS_ENABLED 0 [get_drc_checks {AVAL-151}]
set_property IS_ENABLED 0 [get_drc_checks {AVAL-195}]
set_property IS_ENABLED 0 [get_drc_checks {AVAL-256}]
set_property IS_ENABLED 0 [get_drc_checks {AVAL-267}]
set_property IS_ENABLED 0 [get_drc_checks {AVAL-268}]
set_property IS_ENABLED 0 [get_drc_checks {PDCN-1567}]
...
set_property IS_ENABLED 0 [get_drc_checks {REQP-1812}]
