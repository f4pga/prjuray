...
# BUFCE_ROW -> (32, 11)
RE_BUFCE_ROW = re.compile(r'BUFCE_ROW_X(\d+)Y(\d+)')


def get_site_xy(site):
    """ Return x, y for site

    >>> get_site_xy('BUFCE_ROW_X32Y11')
    (32, 11)
    >>> get_site_xy('BUFCE_ROW_X0Y0')
    (0, 0)
    >>> get_site_xy('BUFCE_ROW_X10Y10')
    (10, 10)
    >>> get_site_xy('BUFCE_ROW_X10Y15')
    (10, 15)
    >>> get_site_xy('BUFCE_ROW_X15Y10')
    (15, 10)
